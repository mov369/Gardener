###########################################################################
## Makefile generated for component 'arduino_robotics_motors_gettingstarted'. 
## 
## Makefile     : arduino_robotics_motors_gettingstarted.mk
## Generated on : Fri Oct 27 11:13:59 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduino_robotics_motors_gettingstarted.elf
...
PRODUCT_NAME              = arduino_robotics_motors_gettingstarted
MAKEFILE                  = arduino_robotics_motors_gettingstarted.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduino_robotics_motors_gettingstarted.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=1 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=59286 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_ANALOG_REF_=0 -D_RTT_PWM_BLOCKS_
...
DEFINES_STANDARD = -DMODEL=arduino_robotics_motors_gettingstarted -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o arduino_robotics_motors_gettingstarted.o arduino_robotics_motors_gettingstarted_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/arduino_robotics_motors_gettingstarted_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/arduino_robotics_motors_gettingstarted_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/arduino_robotics_motors_gettingstarted_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
arduino_robotics_motors_gettingstarted.o : $(START_DIR)/arduino_robotics_motors_gettingstarted_ert_rtw/arduino_robotics_motors_gettingstarted.c
	$(CC) $(CFLAGS) -o "$@" "$<"


arduino_robotics_motors_gettingstarted_data.o : $(START_DIR)/arduino_robotics_motors_gettingstarted_ert_rtw/arduino_robotics_motors_gettingstarted_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/arduino_robotics_motors_gettingstarted_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/arduino_robotics_motors_gettingstarted_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/arduino_robotics_motors_gettingstarted_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/arduino_robotics_motors_gettingstarted_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
